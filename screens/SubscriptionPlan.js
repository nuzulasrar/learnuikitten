    ...
    >
      ...
      >
        ...
        >
          <View style={{ marginRight: 20 }}>
            <Image
              ...
              style={{ width: 77, height: 71, borderRadius: 100 }}
            />
          </View>
          <View>
        ...
        >
          ...
          <View style={{ paddingHorizontal: 40 }}>
            ...
            >
              ...
              <Text style={{ marginLeft: 10, textAlign: "left", fontSize: 18 }}>
                Upload only 1 photo
              </Text>
            </View>
            <View
          ...
          >
            <TouchableOpacity
              ...
              style={{
                marginTop: 10,
                backgroundColor:
                  plantype == 1 ? theme["color-primary-700"] : "white",
                width: 128,
                justifyContent: "center",
                alignItems: "center",
                borderRadius: 0,
            ...
            >
              <Text
                style={{
                  color: plantype == 1 ? "white" : theme["color-primary-500"],
                  fontSize: 18,
                  fontWeight: "bold",
                }}
              >
        ...
        >
          ...
          <View
            style={{
              ...
              borderTopColor: theme["color-danger-600"],
          ...
          <View style={{ flexDirection: "row", justifyContent: "center" }}>
            <Text style={{ color: "white", marginTop: 2, textAlign: "center" }}>
              RM
            </Text>
          ...
          >
            <TouchableOpacity
              ...
              style={{
                marginTop: 10,
                backgroundColor:
                  plantype == 2 ? theme["color-primary-700"] : "white",
                width: 128,
                justifyContent: "center",
                alignItems: "center",
                borderRadius: 0,
            ...
            >
              <Text
                style={{
                  color: plantype == 2 ? "white" : theme["color-primary-500"],
                  fontSize: 18,
                  fontWeight: "bold",
                }}
              >
        ...
        >
          ...
          <Image
            source={require("../assets/images/visahuge.png")}
            style={{ width: 45, height: 33 }}
          />
          <Image
            source={require("../assets/images/mastercardhuge.png")}
            style={{ width: 45, height: 33, marginLeft: 10 }}
          />
          <Image
            source={require("../assets/images/fpxhuge.png")}
            style={{ width: 45, height: 33, marginLeft: 10 }}
          />
